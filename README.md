...
Each time something is merged into the staging or the master branch it will be
...
This will create a new project that uses the committed code in the selected
branch. The new project will be located in the TARGETDIR
